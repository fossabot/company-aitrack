...
| **Go 서버** `aitrack-server-go` | Go 1.25 · chi v5.2.5 · ParadeDB（운영 환경） | Java와 기능이 동등한 경량 대안 구현 |
...
| **최소 수집** | 파일 경로, 변경 diff(unified diff 형식, 변경 줄만), 줄 수 통계, 저장소 메타데이터, 선택적 프롬프트 요약(도구 사용 분류용) 수집; 전체 대화 기록 및 키보드 입력은 수집하지 않음 |
