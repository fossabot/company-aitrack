...
// NewSearchHandler constructs the BM25 search handler adapter.
...
// NewSimilarHandler constructs the pgvector similarity handler adapter.
...
// verifySearchAdminKey checks the X-Admin-Key header. Returns true if valid.
