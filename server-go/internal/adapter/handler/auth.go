...
// NewAuthMiddleware constructs the auth middleware adapter.
func NewAuthMiddleware(ts *application.TokenService, sig *service.SignatureService, cfg *config.Config) *AuthMiddleware {
