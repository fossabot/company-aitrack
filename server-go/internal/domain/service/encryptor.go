...
// NewHmacSecretEncryptor builds an encryptor from a base64-encoded 32-byte key.
// An empty key string selects dev mode (plaintext "plain:" storage).
...
// Encrypt returns the base64 ciphertext for plaintext, or a "plain:" value in dev mode.
...
// Decrypt returns the plaintext for a stored value, handling both "plain:" and ciphertext.
