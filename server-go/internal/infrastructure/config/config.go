...
// variables. It belongs to the infrastructure layer: the domain and
// application layers receive plain values, never this struct.
package config
...
// Load reads configuration from path (if it exists) then applies env overrides.
