...
class ValidationServiceTest {
    ...
    /**
     * Maps the current {@link AiTrackProperties} onto an immutable
     * {@link ValidationPolicy} and reconstructs the service under test.
     * Tests that mutate {@code props} must call this afterwards.
     */
    private void rebuildValidationService() {
